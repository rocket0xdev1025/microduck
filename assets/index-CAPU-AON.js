    ...
    function Si(e, t, n, r, i, a) {
      ...
      if (((r = e), typeof e == `function`)) yi(e) && (o = 1);
        ...
        a: switch (e) {
          case ae:
            return (
              (e = vi(31, n, t, i)), (e.elementType = ae), (e.lanes = a), e
            );
          case y:
          ...
          case x:
            return (
              (e = vi(12, n, t, i | 2)), (e.elementType = x), (e.lanes = a), e
            );
          case ne:
            return (
              (e = vi(13, n, t, i)), (e.elementType = ne), (e.lanes = a), e
            );
          case re:
            return (
              (e = vi(19, n, t, i)), (e.elementType = re), (e.lanes = a), e
            );
          default:
...
`
  ...
  v = [
    ...
    { number: `25`, unit: `cm`, label: `tall`, note: `desk-sized hardware` },
    {
      ...
      unit: `g`,
      label: `light`,
      note: `built to fall & recover`,
    },
    {
      number: `50`,
      unit: `Hz`,
      label: `policy loop`,
      note: `onboard intelligence`,
    },
  ],
  y = [
    [`01`, `Waddle`, `Velocity-tracking gait with unmistakable duck energy.`],
    [`02`, `Grab`, `The articulated beak dips, scoops and carries.`],
    [`03`, `Kick`, `One clean boot, then straight back to walking.`],
    [`04`, `Recover`, `Flat on its back to standing, all by itself.`],
  ],
  b = (e, t = !0) =>
    e
      ? new Intl.NumberFormat(`en-US`, {
          ...
          maximumFractionDigits: t ? 2 : 6,
        }).format(e)
      : `—`;
function x() {
  let [e, t] = (0, l.useState)(!1),
    [n, r] = (0, l.useState)(`Add network`),
    [i, a] = (0, l.useState)(null);
  (0, l.useEffect)(() => {
    let e = new AbortController();
    return (
      fetch(`https://api.dexscreener.com/latest/dex/tokens/${p}`, {
        signal: e.signal,
      })
        .then((e) => {
          if (!e.ok) throw Error(`Market data unavailable`);
          return e.json();
        })
        .then((e) => {
          let t = e.pairs
            ?.filter((e) => e.chainId === `robinhood`)
            .sort(
              (e, t) => (t.liquidity?.usd ?? 0) - (e.liquidity?.usd ?? 0)
            )[0];
          t && a(t);
        })
        .catch(() => void 0),
  ...
  let o = (0, l.useMemo)(() => {
      let e = Number(i?.priceUsd);
      return e ? (e < 0.01 ? `$${e.toFixed(6)}` : b(e, !1)) : `—`;
    }, [i]),
    s = async () => {
      try {
        await navigator.clipboard.writeText(p),
          t(!0),
          window.setTimeout(() => t(!1), 1800);
      } catch {
        t(!1);
      }
    };
  return (0, f.jsxs)(`main`, {
    children: [
      (0, f.jsxs)(`header`, {
        ...
        children: [
          (0, f.jsxs)(`a`, {
            className: `brand`,
            href: `#top`,
            "aria-label": `microduck home`,
            children: [
              (0, f.jsxs)(`span`, {
                className: `brand-mark`,
                children: [
                  (0, f.jsx)(`img`, { src: `/media/duck-head.webp`, alt: `` }),
                  (0, f.jsx)(`img`, {
                    className: `brand-mark-open`,
                    src: `/media/duck-head-open.webp`,
                    alt: ``,
                  }),
                ],
              }),
              (0, f.jsx)(`span`, { children: `microduck` }),
            ],
          }),
          (0, f.jsxs)(`nav`, {
            "aria-label": `Main navigation`,
            children: [
              (0, f.jsx)(`a`, { href: `#story`, children: `Story` }),
              (0, f.jsx)(`a`, { href: `#specs`, children: `Duck data` }),
              (0, f.jsx)(`a`, { href: `#token`, children: `Token` }),
            ],
          }),
          (0, f.jsxs)(`div`, {
            ...
            children: [
              (0, f.jsx)(`a`, {
                ...
                target: `_blank`,
                rel: `noreferrer`,
                "aria-label": `Follow microduck on X`,
                children: (0, f.jsx)(`span`, { children: `𝕏` }),
              }),
              (0, f.jsxs)(`a`, {
                className: `header-trade`,
                href: m,
                target: `_blank`,
                rel: `noreferrer`,
                children: [
      ...
      (0, f.jsxs)(`section`, {
        ...
        children: [
          (0, f.jsx)(`video`, {
            ...
            loop: !0,
            playsInline: !0,
            poster: `/media/squad.webp`,
            "aria-label": `MicroDuck walking, standing on a desk and riding a skateboard`,
            children: (0, f.jsx)(`source`, {
              src: `/media/microduck-hero.mp4`,
              type: `video/mp4`,
            }),
          }),
          (0, f.jsx)(`div`, { className: `hero-shade` }),
          (0, f.jsxs)(`div`, {
            className: `hero-copy`,
            children: [
              (0, f.jsxs)(`div`, {
                className: `eyebrow`,
                children: [
                  (0, f.jsx)(`span`, { className: `live-dot` }),
                  ` Unofficial community token · Solana`,
                ],
              }),
              (0, f.jsxs)(`h1`, {
                children: [
                  `Tiny duck.`,
                  (0, f.jsx)(`span`, { children: `Big waddle.` }),
                ],
              }),
              (0, f.jsx)(`p`, {
                className: `hero-intro`,
                children: `The internet found a 25 cm robot that walks, grabs, skates and gets back up. Naturally, it put the duck onchain.`,
              }),
              (0, f.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, f.jsxs)(`button`, {
                ...
                children: [
                  ...
                  `…`,
                  p.slice(-6),
                  (0, f.jsx)(`strong`, { children: e ? `COPIED` : `COPY` }),
                ],
              }),
            ],
          }),
          (0, f.jsx)(`div`, {
            ...
            "aria-hidden": `true`,
            children: `SCROLL TO WADDLE ↓`,
          }),
        ],
      }),
      (0, f.jsx)(`div`, {
        className: `ticker`,
        "aria-label": `microduck token highlights`,
          ...
          children: [0, 1].map((e) =>
            (0, f.jsxs)(
              `div`,
              {
                ...
                "aria-hidden": e === 1,
                children: [
                  (0, f.jsx)(`span`, { children: `1 BILLION FIXED SUPPLY` }),
                  (0, f.jsx)(`span`, { children: `PAIRED WITH NVDA` }),
                  (0, f.jsx)(`span`, { children: `15 MOTORS / ZERO FEAR` }),
                  (0, f.jsx)(`span`, { children: `Solana` }),
                ],
              },
              e
            )
      ...
      (0, f.jsxs)(`section`, {
        ...
        children: [
          ...
          (0, f.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, f.jsxs)(`div`, {
                ...
                children: [
                  (0, f.jsx)(`p`, {
                    children: `MicroDuck is a real open-source-software robot by Pollen Robotics: small enough for a desk, smart enough to train in simulation, and stubborn enough to stand back up after a fall.`,
                  }),
                  (0, f.jsxs)(`p`, {
                    children: [
                      (0, f.jsx)(`strong`, {
                        children: `$microduck is the community-made echo.`,
                      }),
                      ` No roadmap full of fantasy. Just a wonderfully weird machine, a fresh chain, and a flock that keeps moving.`,
                    ],
                  }),
                ],
              }),
          ...
          (0, f.jsxs)(`div`, {
            ...
            children: [
              (0, f.jsx)(`img`, {
                src: `/media/watching.webp`,
                alt: `MicroDuck watching someone code at a desk`,
              }),
              (0, f.jsxs)(`div`, {
                className: `image-caption`,
                children: [
                  (0, f.jsx)(`span`, {
                    children: `REAL ROBOT / REAL PLASTIC / VERY SERIOUS BEAK`,
                  }),
                  (0, f.jsx)(`span`, { children: `PHOTO: POLLEN ROBOTICS` }),
                ],
              }),
              (0, f.jsxs)(`div`, {
                className: `sticker-note`,
                children: [`WADDLE`, (0, f.jsx)(`br`, {}), `PROTOCOL`],
              }),
            ],
          }),
        ],
        ...
        children: [
          (0, f.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, f.jsx)(`p`, {
                children: `Product facts from the real MicroDuck, the machine behind the meme.`,
              }),
            ],
          }),
          (0, f.jsx)(`div`, {
                ...
                `article`,
                {
                  children: [
                    (0, f.jsxs)(`div`, {
                      ...
                      children: [
                        e.number,
                        (0, f.jsx)(`small`, { children: e.unit }),
                      ],
                    }),
                    (0, f.jsx)(`h3`, { children: e.label }),
                    (0, f.jsx)(`p`, { children: e.note }),
                  ],
                },
                e.label
              )
          ...
          (0, f.jsxs)(`div`, {
            ...
            children: [
              (0, f.jsxs)(`div`, {
                className: `moves-copy`,
                children: [
                  (0, f.jsx)(`span`, { children: `WHAT THE DUCK DOES` }),
                  (0, f.jsxs)(`h3`, {
                    children: [
                      `Train in sim.`,
                      (0, f.jsx)(`br`, {}),
                  ...
                  (0, f.jsx)(`a`, {
                    ...
                    target: `_blank`,
                    rel: `noreferrer`,
                    children: `Meet the real robot ↗`,
                  }),
                ],
              }),
              (0, f.jsx)(`div`, {
                className: `moves-list`,
                children: y.map(([e, t, n]) =>
                  (0, f.jsxs)(
                    `div`,
                    {
                      className: `move-row`,
        ...
        children: [
          (0, f.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, f.jsx)(`img`, {
                src: `/media/pack-robot.webp`,
                alt: `Illustrated MicroDuck standing on a desk`,
              }),
            ],
          }),
          (0, f.jsxs)(`div`, {
              ...
              (0, f.jsxs)(`article`, {
                ...
                children: [
                  (0, f.jsx)(`span`, {
                    ...
                    children: `THE ONLY ADDRESS THAT MATTERS`,
                  }),
                  (0, f.jsx)(`code`, { children: p }),
                  (0, f.jsx)(`button`, {
                    onClick: s,
                    children: e ? `ADDRESS COPIED ✓` : `COPY CONTRACT`,
                  }),
                  (0, f.jsx)(`p`, {
                    children: `Always verify the full contract before interacting. Names and symbols can be copied; addresses cannot.`,
                  }),
                ],
              }),
              (0, f.jsxs)(`article`, {
                className: `token-facts`,
                children: [
                  (0, f.jsxs)(`div`, {
                    children: [
                      (0, f.jsx)(`span`, { children: `Network` }),
                      (0, f.jsx)(`strong`, { children: `Solana` }),
                    ],
                  }),
                  (0, f.jsxs)(`div`, {
                    children: [
                      (0, f.jsx)(`span`, { children: `Token` }),
                      (0, f.jsx)(`strong`, { children: `microduck` }),
                    ],
                  }),
                  (0, f.jsxs)(`div`, {
                    children: [
                      (0, f.jsx)(`span`, { children: `Total supply` }),
                      (0, f.jsx)(`strong`, { children: `1,000,000,000` }),
                    ],
                  }),
                  (0, f.jsxs)(`div`, {
                    children: [
                      (0, f.jsx)(`span`, { children: `Launchpad` }),
                      (0, f.jsx)(`strong`, { children: `pump.fun` }),
                    ],
                  }),
                ],
              }),
      ...
      (0, f.jsxs)(`section`, {
        ...
        children: [
          ...
          (0, f.jsxs)(`figure`, {
            ...
            children: [
              (0, f.jsx)(`img`, {
                src: `/media/kickabout.webp`,
                alt: `Two MicroDucks playing with a ball on turf`,
              }),
              (0, f.jsx)(`figcaption`, {
                children: `THE FLOCK HAS BALL CONTROL`,
              }),
            ],
          }),
          (0, f.jsxs)(`figure`, {
            ...
            children: [
              (0, f.jsx)(`img`, {
                src: `/media/skate.webp`,
                alt: `MicroDuck outdoors next to a skater's shoe`,
              }),
              (0, f.jsx)(`figcaption`, {
                children: `GOLDEN HOUR / TINY WHEELS`,
              }),
            ],
          }),
        ],
      ...
      (0, f.jsxs)(`section`, {
        ...
        children: [
          (0, f.jsx)(`img`, {
            src: `/media/squad.webp`,
            alt: `Four MicroDucks standing in a row`,
          }),
          (0, f.jsxs)(`div`, {
            children: [
              (0, f.jsx)(`span`, { children: `END OF TAPE` }),
              (0, f.jsxs)(`h2`, {
                children: [
                  `Keep calm.`,
                  (0, f.jsx)(`br`, {}),
...
(0, u.createRoot)(document.getElementById(`root`)).render(
  (0, f.jsx)(l.StrictMode, { children: (0, f.jsx)(x, {}) })
);
